...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideMatchMateRepository(internetChecker: InternetChecker, apiService: MatchMateApiService, localDataSource: MatchMateLocalDataSource) : MatchMateRepository {
